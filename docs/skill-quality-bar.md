...
| Parallel reviewer lanes | Review dimensions are independent and the expected value beats context cost. | Bounded dispatch packets and role reports using the shared report contract. |

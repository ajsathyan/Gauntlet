...
| Execution integration topology | Add + move | Keep `main` clean, integrate child checkpoints into one parent branch, and use one final PR per Execution Run; split independent release boundaries into separate runs. | `docs/prd-execution.md`, `docs/github-discipline.md`, `docs/local-documentation.md`, `skills/implement-prd/references/execution-contract.md` |

...
- The rejected child packets contained 148 tokens more than their accepted rewrites, or +7.7% relative to the accepted full packets. Because the rewrites also shortened substantive detail, this is an upper bound on duplication cost rather than proof of dispatch waste.
